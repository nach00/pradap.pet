...
export default function WorkDetailsPage({
  ...
  // Check if this is an existing project (from old projects)
  const project = projects.find((p) => p.slug === slug);
  
  if (project) {
    // Render using existing SingleProject component for legacy projects
    return (
      <Container>
  ...
  const projectData = {
    ...
    status: "Completed",
    description: "This is a comprehensive project description that explains the context, challenges, and solutions implemented.",
    ...
    <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {projectData.liveUrl && (
                <ButtonText variant="primary" className="inline-flex items-center gap-2">
                  <IconExternalLink className="w-4 h-4" />
                  View Live Project
                </ButtonText>
              )}
              {projectData.githubUrl && (
                <ButtonText variant="secondary" className="inline-flex items-center gap-2">
      ...
      <div className="py-16">
        <div className="aspect-video bg-neutral-200 rounded-lg flex items-center justify-center mb-4">
          <SmallText className="text-neutral-500">Featured Project Image</SmallText>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <Paragraph>
              ...
              What was the context and why was this project necessary?
            </Paragraph>
          </div>
          ...
          <div>
            ...
            <Paragraph>
              Explain the approach taken to solve the challenges. 
              What methods, technologies, or strategies were employed?
            </Paragraph>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 border-t border-neutral-200">
        ...
        <div className="space-y-12">
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              <SubsectionHeading className="mb-4">Research & Discovery</SubsectionHeading>
              <Paragraph>
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              <SubsectionHeading className="mb-4">Design & Prototyping</SubsectionHeading>
              <Paragraph>
                Describe the design process, wireframing, prototyping, 
                and iteration cycles that led to the final solution.
              </Paragraph>
            </div>
          </div>
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              <SubsectionHeading className="mb-4">Development & Testing</SubsectionHeading>
              <Paragraph>
                Explain the development approach, testing strategies, 
      ...
      <div className="py-16 border-t border-neutral-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <SmallText className="text-neutral-600">Improvement Metric</SmallText>
          </div>
          <div className="text-center">
            <div className="text-4xl font-light text-neutral-900 mb-2">2.5x</div>
            <SmallText className="text-neutral-600">Performance Increase</SmallText>
          </div>
          <div className="text-center">
            <div className="text-4xl font-light text-neutral-900 mb-2">98%</div>
            <SmallText className="text-neutral-600">User Satisfaction</SmallText>
          </div>
        </div>
      ...
      <div className="py-16 border-t border-neutral-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            <SectionHeading className="mb-4">Areas for Improvement</SectionHeading>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 bg-amber-500 rounded-full mt-2 flex-shrink-0"></div>
                <SmallText>Another lesson learned or optimization opportunity</SmallText>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="py-16 border-t border-neutral-200">
        ...
        <Paragraph>
          Outline future plans for the project, potential enhancements, 
          or related work that will build on this foundation.
        </Paragraph>
      </div>
      ...
      <div className="py-16 border-t border-neutral-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Link href="/work/project-1" className="group">
            ...
            <SmallText className="text-neutral-600">Brief description of related work</SmallText>
          </Link>
