		...
		<Container>
			...
			<div className="pt-20 pb-24">
				...
				<Lede className="max-w-4xl">
					Exploring the intersection of design and engineering through articles
					on AI, interface design, and human-centered technology.
				</Lede>
			</div>

			{/* Featured Posts */}
			<div className="pb-24">
				<Subheading className="mb-12">Featured</Subheading>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					{featuredPosts.map((post, index) => (
						<Link key={post.slug} href={`/blog/${post.slug}`} className="group">
							...
							<Paragraph className="text-sm">{post.description}</Paragraph>
							{post.tags && (
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
				...
				<div className="lg:col-span-2">
					<Subheading className="mb-12">Recent Posts</Subheading>
				...
				<div className="space-y-12">
					{/* Categories */}
					<div>
						<SectionHeading className="mb-6">Categories</SectionHeading>
						<div className="space-y-3">
							{categories.map(
								(category: { name: string; count: number }, index: number) => (
									<div
										key={index}
					...
					<div className="bg-gray-50 rounded-lg p-6">
						<SectionHeading className="mb-4">Newsletter</SectionHeading>
						<Paragraph className="text-sm mb-6">
							Get the latest articles on design engineering and AI directly in
							your inbox.
						</Paragraph>
