...
export function ProjectCard({
	...
	return (
		<>
			{/* <div className="grid grid-cols-[min-content_1fr] grid-rows-[min-content_1fr] hover:scale-100 transition-all duration-500 hover:shadow-md rounded-md"> */}
			{/* 	<div className="aspect-square flex items-center justify-center border p-1 bg-[var(--base-3)] border-b-0 border-r-0"> */}
			{/* 		{currentLogo && ( */}
			{/* 			<div */}
			...
			{/* 		)} */}
			{/* 	</div> */}
			{/* 	<div className="flex items-center p-5 border border-b-0"> */}
			{/* 		<H3>{title}</H3> */}
			{/* 	</div> */}
			{/* 	<div className="border bg-[var(--base-3)] border-t-0 border-r-0" /> */}
			{/* 	<div className="flex items-start border px-5 border-t-0 flex-col gap-4 pb-8"> */}
			{/* 		<P className="max-w-[60ch]">{description}</P> */}
			{/* 		<span className="text-xl text-[var(--accent-9)]">View project →</span> */}
			{/* 	</div> */}
			{/* </div> */}
